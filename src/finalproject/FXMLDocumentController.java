...
public class FXMLDocumentController implements Initializable {
    ...
    private void startConnectFour(ActionEvent event){
        gamePlay = new ConnectFourGame(6, 7, playerOne.textProperty().getValue(), playerTwo.textProperty().getValue(), gameplayPane);
    ...
    private void startOTTOFour(ActionEvent event){
        gamePlay = new OTTOandTOOTGame(6, 7, playerOne.textProperty().getValue(), playerTwo.textProperty().getValue(), gameplayPane);
